...
def get_data(path: str) -> pd.DataFrame:
    ...
    df = df[['Дата', 'Выявлено всего', 'Выздоровевших и умерших', 'Заражений за день', '% прирост', 'Выздоровлений',
             'Выздоровлений за день', '% Выздоровлений', 'Смертей', 'Смертей за день', '% Смертей', 'Летальность, %',
             'Характерстика ДБ']]
