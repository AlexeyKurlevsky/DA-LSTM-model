...
class Model:
    def __init__(self, model_name, model_stage):
        try:
            self.weight_path = mlflow.artifacts.download_artifacts(
    ...
    def predict(self, data):
        ...
        (
            ...
            X_test,
            y_test,
        ) = w_one_target.get_data_to_model()
        y_pred = self.model.predict_interval(
            np.expand_dims(X_test[-1], axis=0), w_one_target.conf.n_future
        )
